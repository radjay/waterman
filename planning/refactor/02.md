...
4. Test with edge cases (0°, 360°, wrap-around ranges)
...
2. **Edge Cases**: Test with edge cases (0°, 360°, wrap-around ranges, missing data)
...
- ✅ More testable code (utilities can be unit tested)
...
- ✅ Potential for future optimizations (e.g., memoization)
