 ...
 *
 * `coords: [lat, lng]` is a representative point for the cluster (the
 * primary spot's real-world coordinates, hand-sourced — not in the original
 * dataset), used by the /destinations map view's route lines. It is NOT
