import { AuthProvider, EmailLoginForm, MagicLinkSent, Heading, Text, Card } from 'waterman';

const noop = () => {};

// AuthProvider is the session context every auth-aware surface sits inside —
// app/layout wraps the whole tree in it. It renders no chrome of its own, so a
// useful story is the provider around the surface it powers: the sign-in panel.
