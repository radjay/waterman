import { BottomNav, Section, Card, Text, Heading, ScoreDial } from 'waterman';
        ...
        <div className="flex flex-col gap-3">
          <Card>
            <div className="flex items-start justify-between gap-3">
              ...
              <ScoreDial score={87} sport="wingfoil" size="sm" />
            </div>
          </Card>
          <Card>
            <div className="flex items-start justify-between gap-3">
              ...
              <ScoreDial score={72} sport="kitesurfing" size="sm" />
            </div>
          </Card>
          <Card>
            <div className="flex items-start justify-between gap-3">
              ...
              <ScoreDial score={64} sport="surfing" size="sm" />
            </div>
          </Card>
        </div>
      </Section>
