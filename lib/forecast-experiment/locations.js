...
// Cascais Bay is outside ICON-D2, AROME, HARMONIE, and ICON 2I domains on Open-Meteo
// Previous Runs (no usable wind at 38.69°N, -9.42°W). icon_eu (~7 km) is the best
// DWD high-res option here; Windy ICON7 maps to that, not icon_d2.
...
/** Open-Meteo slug for marina wind charts and other experiment UI forecast display. */
export const EXPERIMENT_DISPLAY_FORECAST_MODEL = "icon-eu";

/** Prefer ICON7; fall back when its ingest horizon is shorter than other models. */
export const EXPERIMENT_FORECAST_MODEL_PRIORITY = [
  "icon-eu",
  "icon-global",
  "gfs-global",
  "ecmwf-ifs-hres-9km",
