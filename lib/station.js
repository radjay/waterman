...
export function buildStationCard({
  ...
  return {
    ...
    // Raw meteorological FROM bearing — LiveStationBadge (and any other
    // surface) must run it through getDisplayWindDirection for the TO label.
    // Keeping both stops a stale pre-baked label from drifting off the flip.
