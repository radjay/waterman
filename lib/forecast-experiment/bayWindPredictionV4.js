...
export function buildBayWindPredictionV4({
  ...
  const v2Rideable = v2.kickInP50At != null;
  ...
  if (!rideable) {
    return {
      ...
      kickInP50At: undefined,
      kickInP75At: undefined,
  ...
  if (v2Rideable && v3Rideable) {
    kickInP50At = blendTimes(v2.kickInP50At, v3.kickInP50At, v3Weight);
    kickInP75At = blendTimes(v2.kickInP75At, v3.kickInP75At, v3Weight);
  } else if (allowV3Alone) {
    kickInP50At = v3.kickInP50At;
    kickInP75At = v3.kickInP75At;
  } else {
    kickInP50At = v2.kickInP50At;
    kickInP75At = v2.kickInP75At;
  }

  kickInP50At = applyCaboLagFloor(kickInP50At, caboFloorMs);
  kickInP75At = applyCaboLagFloor(kickInP75At, caboFloorMs);
  ...
  return {
    ...
    probabilityTimeline,
    confidence,
    summary: summaryV4({ kickInP50At, kickInP75At, peak, v2Rideable, v3Rideable, isNortada }),
    inputs: ensembleInputs(v2, v3, {
      mode,
...
function v3KickInSupportedByTimeline(v3) {
  if (v3.kickInP50At == null) return false;
...
function ensembleInputs(v2, v3, extra) {
  return {
    ...
    v2KickInP50At: v2.kickInP50At,
    v3KickInP50At: v3.kickInP50At,
...
function summaryV4({ kickInP50At, kickInP75At, peak, v2Rideable, v3Rideable, isNortada }) {
  if (!kickInP50At) {
